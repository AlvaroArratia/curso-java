...
INSERT INTO friendships (user_id, friend_id) SELECT (SELECT users.id FROM users WHERE CONCAT(users.first_name, ' ', users.last_name)='Eli Byers'), (SELECT users.id FROM users WHERE CONCAT(users.first_name, ' ', users.last_name)='Alvaro Arratia');
INSERT INTO friendships (user_id, friend_id) SELECT (SELECT users.id FROM users WHERE CONCAT(users.first_name, ' ', users.last_name)='Kermit The Frog'), (SELECT users.id FROM users WHERE CONCAT(users.first_name, ' ', users.last_name)='Alvaro Arratia');
INSERT INTO friendships (user_id, friend_id) SELECT (SELECT users.id FROM users WHERE CONCAT(users.first_name, ' ', users.last_name)='Marky Mark'), (SELECT users.id FROM users WHERE CONCAT(users.first_name, ' ', users.last_name)='Alvaro Arratia');
